...
public class App {
    ...
    public static void main(String[] args) throws InvalidTopologyException, AuthorizationException, AlreadyAliveException //throws Exception
    {
...
//        config.put(Config.NIMBUS_SEEDS, Arrays.asList("193.112.72.65")); //配置nimbus连接主机地址，比如：192.168.10.1
//        config.put(Config.NIMBUS_THRIFT_PORT, 6627);//配置nimbus连接端口，默认 6627
//        config.put(Config.STORM_ZOOKEEPER_SERVERS, Arrays.asList("193.112.72.65")); //配置zookeeper连接主机地址，可以使用集合存放多个
//        config.put(Config.STORM_ZOOKEEPER_PORT, 2888); //配置zookeeper连接端口，默认2181
...
//        config.setNumWorkers(1);
        ...
        System.setProperty("storm.jar", "E:\\code_github\\storm\\target\\storm-1.0-SNAPSHOT.jar");
